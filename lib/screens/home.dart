...
// //
// //     int cardioTotal = 0, strengthTotal = 0;
// //     List<String> cardioInts = [], strengthInts = [];
// //
// //     for (final day in weekData!) {
// //       for (final ex in day.exercises) {
// //         if (ex.type.toLowerCase().contains('cardio')) {
// //           cardioTotal += ex.duration;
// //           cardioInts.add(ex.intensity);
// //         } else {
// //           strengthTotal += ex.duration;
// //           strengthInts.add(ex.intensity);
// //         }
// //       }
// //     }
// //
// //     bool needCardio = cardioTotal < cardioGoal;
// //     bool needStrength = !needCardio && (strengthTotal < strengthGoal);
// //
...
// //                   Text(
// //                     "Time this week: $currentMinutes / $recommendedMinutes minutes",
...
//   List<String> cardioInts = [], strengthInts = [];
//
//   // Calculate total cardio/strength minutes for the week (existing logic)
//   for (final day in weekData!) {
//     for (final ex in day.exercises) {
//       if (ex.type.toLowerCase().contains('cardio')) {
...
//   int cardioToday = 0;
//   int strengthToday = 0;
//   final todayDataLocal = weekData!.firstWhere(
//     (d) =>
//       d.year == today.year &&
//       d.month == today.month &&
//       d.day == today.day,
